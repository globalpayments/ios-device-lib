...
extension BBPOSDuplicateTransactionTests: GMSTransactionDelegate {
    func onStatusUpdate(_ transactionStatus: ios_device_lib.HpsTransactionStatus) {
    ...
    func onTransactionWaitingForSurchargeConfirmation(result: ios_device_lib.HpsTransactionStatus,
...
extension BBPOSDuplicateTransactionTests: HpsC2xDeviceDelegate, GMSClientAppDelegate {
    ...
    func onStatus(_ status: ios_device_lib.HpsTransactionStatus) {
