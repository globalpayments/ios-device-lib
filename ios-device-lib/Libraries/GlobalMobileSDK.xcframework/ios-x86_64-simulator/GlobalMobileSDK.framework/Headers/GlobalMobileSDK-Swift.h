...
SWIFT_ENUM_FWD_DECL(NSUInteger, PinLength)
SWIFT_ENUM_FWD_DECL(NSUInteger, TerminalAuthenticationCapability)
SWIFT_ENUM_FWD_DECL(NSUInteger, TerminalOperatingEnvironment)
SWIFT_ENUM_FWD_DECL(NSUInteger, TerminalOutputCapability)
SWIFT_ENUM_FWD_DECL(NSUInteger, TerminalCapability)
SWIFT_ENUM_FWD_DECL(NSInteger, EncryptionType)
SWIFT_ENUM_FWD_DECL(NSUInteger, RUATerminalType)
...
SWIFT_ENUM_FWD_DECL(NSUInteger, TransactionStatus)
...
@class UIImage;
SWIFT_ENUM_FWD_DECL(NSUInteger, TransactionResult)
