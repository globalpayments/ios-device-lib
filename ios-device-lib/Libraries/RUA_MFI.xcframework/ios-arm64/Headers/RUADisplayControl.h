...
typedef enum {
    ...
    /** 8: UTF-8 Character Set  */
    RUADisplayTextCharsetUTF8,
 ...
 * @param row                   Row number
 * @param column                Column number
 * @param charset               RUADisplayTextCharset.EMVL1 or DisplayTextCharset.EMVL2 or DisplayTextCharset.UTF8
 * @param text                  Textstring
 * @param response              OnResponse block
 */
- (void)writeTextUsingCodeTable:(int)row column:(int)column charset:(RUADisplayTextCharset)charset test:(NSString * _Nonnull)text response:(OnResponse _Nonnull)response;
