...
- (void)retrieveKeyedCardDataOnGuard:(OnProgress _Nonnull)progress response:(OnResponse _Nonnull)response;
...
- (void)retrieveKeyedCardDataOnGuard:(RUAKeyedData)keyedData progress:(OnProgress _Nonnull)progress response:(OnResponse _Nonnull)response;
