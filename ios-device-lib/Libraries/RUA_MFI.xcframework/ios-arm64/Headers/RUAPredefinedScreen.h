...
#ifndef RUAPredefinedScreen_h
#define RUAPredefinedScreen_h

typedef NS_ENUM (NSInteger, RUADisplayPredefinedScreen) {
    //    0    C0FD
    DSP_EXT_DECLINED = 0,
    //    1    C0EA
