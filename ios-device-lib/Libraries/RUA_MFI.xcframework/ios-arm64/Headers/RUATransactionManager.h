 ...
 * @param response OnResponse block
 */
- (void)waitForCardRemoval:(NSInteger)cardRemovalTimeout paymentInterface:(RUAPaymentInterface)interface response:(OnResponse _Nonnull)response;
...
-(void)displayPredefinedScreen: (RUADisplayPredefinedScreen)screenIndex andLanguage : (NSString *_Nullable) language response: (OnResponse _Nonnull)response;
