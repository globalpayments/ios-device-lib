...
typedef  enum {
	RUADeviceTypeRP350x __attribute__((deprecated("RUADeviceTypeRP350x is deprecated, consider upgrading your device to recent device model."))),
    RUADeviceTypeMOBY3000 __attribute__((deprecated("RUADeviceTypeMOBY3000 is deprecated, consider upgrading your device to recent device model."))),
    RUADeviceTypeRP450c __attribute__((deprecated("RUADeviceTypeRP450c is deprecated, consider upgrading your device to recent device model."))),
	RUADeviceTypeRP750x __attribute__((deprecated("RUADeviceTypeRP750x is deprecated, consider upgrading your device to recent device model."))),
    RUADeviceTypeRP45BT __attribute__((deprecated("RUADeviceTypeRP45BT is deprecated, consider upgrading your device to recent device model."))),
    RUADeviceTypeMOBY8500,
    RUADeviceTypeMOBY9500,
...
/**
 ...
 @deprecated
 */
- (BOOL)initializeDevice:(id <RUADeviceStatusHandler> _Nonnull)statusHandler __deprecated_msg("Use the initializeDevice with JSON parameter");
...
/**
 ...
 @deprecated
 */
- (BOOL)initializeDevice:(id <RUADeviceStatusHandler> _Nonnull)statusHandler andTimeout:(int)timeout __deprecated_msg("Use the initializeDevice with JSON parameter");

/**
 Initializes the roam reader with defined timeout  and Json content and registers the status handler for device status updates.
 <p>
 Usage:
 <code>
 <br>
 ...
 @param statusHandler the roam reader  status handler
 @param timeout defined timeout in millisecond(Default 30 seconds)
 @param jsonContent content of JSON provisioning
 @see RUADeviceStatusHandler
 @return true if successful
 */
- (BOOL)initializeDevice:(id <RUADeviceStatusHandler> _Nonnull)statusHandler andTimeout:(int)timeout andJsonContent :(NSString* _Nonnull) jsonContent;

/**
 Initializes the roam reader with defined timeout and Json content and registers the status handler for device status updates. If autoJsonprovisioning is true, push JSON provisioning to the reader if needed.
 <p>
 Usage:
 <code>
 <br>
 ...
 @param timeout defined timeout in millisecond(Default 30 seconds)
 @param jsonContent content of JSON provisioning
 @param autoJsonProvisioning push JSON provisioning to the reader if needed
 @see RUADeviceStatusHandler
 @return true if successful
 */
- (BOOL)initializeDevice:(id <RUADeviceStatusHandler> _Nonnull)statusHandler andTimeout:(int)timeout andJsonContent :(NSString* _Nonnull) jsonContent andAutoJsonProvisioning:(BOOL)autoJsonProvisioning;
...
/**
 ...
 RUAParameterBatteryLevel(The value is -1  if the device is charging),
 RUAParameterIsDeviceCharging
 <br>
 @param response OnResponse block
 */
...
@return true if successful
 @deprecated
*/
- (BOOL)initializeDevice:(id <RUADeviceStatusHandler> _Nonnull)statusHandler pairingListener:(id <RUAPairingListener> _Nonnull) pairListener __deprecated_msg("Use the initializeDevice with JSON parameter");

/**
 Initializes the card reader with a json content and registers the status handler for device status updates.
 Supports pairing LED pairing for Moby5500
 @param statusHandler device status handler
 @see RUADeviceStatusHandler
 @param pairListener LED Pairing listener
 @see RUAPairingListener
 @param jsonContent the provisioning JSON for the device
 @param autoJsonProvisioning use the json content as provisioning if true
 @return true if successful
 */
- (BOOL)initializeDevice:(id <RUADeviceStatusHandler> _Nonnull)statusHandler pairingListener:(id <RUAPairingListener> _Nonnull) pairingListener jsonContent :(NSString* _Nonnull) jsonContent autoJsonProvisioning:(BOOL) autoJsonProvisioning;
