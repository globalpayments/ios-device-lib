...
#import "RUARKIErrorCodes.h"
#import "RUALEDMode.h"
// endregion PreGeneratorImports
...
+ (NSString *)RUADisplayPredefinedScreen_toString:(RUADisplayPredefinedScreen)screenId;
...
/**
 Converts enum to string
 @param status RUAAPDUResponseType enumeration
 @return String value of the parameter
 @see RUAAPDUResponseType
 */

+(NSString*)RUAAPDUResponseType_toString:(RUAAPDUResponseType)enumVal;

/**
 Converts string to enum
 @param strVal String value of the enum value
 @return RUAAPDUResponseType enum value
 @see RUAAPDUResponseType
 */

+(RUAAPDUResponseType)RUAAPDUResponseType_toEnumeration:(NSString*)strVal;
/**
 Converts enum to string
 @param status RUARKIErrorCodes enumeration
 @return String value of the parameter
 @see RUARKIErrorCodes
 */

+(NSString*)RUARKIErrorCodes_toString:(RUARKIErrorCodes)enumVal;

/**
 Converts string to enum
 @param strVal String value of the enum value
 @return RUARKIErrorCodes enum value
 @see RUARKIErrorCodes
 */

+(RUARKIErrorCodes)RUARKIErrorCodes_toEnumeration:(NSString*)strVal;
/**
 Converts enum to string
 @param status RUALEDMode enumeration
 @return String value of the parameter
 @see RUALEDMode
 */

+(NSString*)RUALEDMode_toString:(RUALEDMode)enumVal;

/**
 Converts string to enum
 @param strVal String value of the enum value
 @return RUALEDMode enum value
 @see RUALEDMode
 */

+(RUALEDMode)RUALEDMode_toEnumeration:(NSString*)strVal;
// endregion PreGeneratorEnums
