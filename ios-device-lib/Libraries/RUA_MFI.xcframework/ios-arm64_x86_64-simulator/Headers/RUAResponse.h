...
typedef  enum  : NSUInteger{
    ...
    /** 8EB0 [DAMO] Key has been expired*/
    RUAErrorKeyExpired = 141,
    
    /** 8EB1 [DAMO] Key not found*/
    RUAErrorKeyNotFounded = 142,
    
    /** 8EB2 [DAMO] Key exchange should be performed via user interface*/
    RUAErrorKeyExchangeRequiredByUI = 143,
    
    /** 8EB3 [DAMO] Maxium encryption limit has been reached, key exchange is required*/
    RUAErrorDuKptMaximumEncrytptionReached = 144,
    
    /** 8EB4 [DAMO] No more key exchange is allowed*/
    RUAErrorNoMoreKeyExchangePossible = 145,
    
    /** 8EC0 [DAMO] Key injection error due to MAC verification*/
    RUAErrorKeyInjectionErrorVerifyMac = 146,
    
    /** 8EC1 [DAMO] Key injection error due to KSN verification*/
    RUAErrorKeyInjectionErrorVerifyKSN = 147,
    
    /** 8EC2 [DAMO] Key injection error due to wrong PIEK length*/
    RUAErrorKeyInjectionErrorVerifyIPEKLength = 148,
    
    /** 8EC3 [DAMO] Key injectino error due to hash verification*/
